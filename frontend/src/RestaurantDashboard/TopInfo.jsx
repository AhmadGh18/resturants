...
const TopInfo = (props) => {
  ...
  return (
    <>
      <div className="flex items-center g-gray-100 ">
        <div className="container max-w-7xl px-6 mx-auto my-10">
          <div className="grid gap-9 sm:grid-cols-2 lg:grid-cols-4">
            <div className="bg-white shadow-sm rounded p-5">
              <div className="flex space-x-4 items-center">
                ...
                <div>
                  <div className="text-gray-400">Total viewr</div>
                  <div className="text-2xl font-bold text-gray-900">
                    {totalViewr && totalViewr}
                  </div>
                </div>
              </div>
            </div>
