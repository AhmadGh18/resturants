    ...
    <div className="flex">
      ...
      >
        ...
        <div className="flex flex-col justify-between flex-1 mt-6">
          <nav>
            <Link
              className="flex items-center px-4 py-2 rounded-md dark:text-gray-200"
              to="/main/restaurantPage/dashboard"
            >
              <svg
                className="w-5 h-5"
                viewBox="0 0 24 24"
            ...
            <Link
              className="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-md dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
              to="/main/restaurantPage/dashboard/manageItem"
            >
              <svg
                className="w-5 h-5"
                viewBox="0 0 24 24"
          ...
          <a href="#" className="flex items-center px-4 -mx-2">
            <img
              ...
              src={
                ...
                `http://localhost:8000/storage/${restaurant.restaurant.profile_picture}`
              }
              alt="avatar"
            />
            <span className="mx-2 font-medium text-gray-800 dark:text-gray-900">
              {User && User.full_name}
            </span>
          </a>
        </div>
